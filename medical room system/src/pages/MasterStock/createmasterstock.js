...
const CreateMasterStock = ({ func }) => {
  ...
  const checkDuplicateID = async (id) => {
    const response = await fetch(`http://localhost:8090/api/masterstock/checkDuplicateID/` + id, {
      method: 'GET',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Modal.Body className="col-11  mx-auto" closeButton>
                <div className="row" style={{ marginTop: '-20px' }}>
                  <div className="col-7">
                    <h3 className="mb-5">Add เหตุผลปรับStock</h3>
                  </div>
                </div>
                <div className="row">
                  <Col lg="6">
                  ...
                  <Col lg="6">
                    <Form.Group className="form-group">
                      <label for="exampleSelect">Type:</label>  <label className="form-label textmark"> *</label>
                      <Input
                        type="select"
                        value={Type}
...
export default CreateMasterStock
